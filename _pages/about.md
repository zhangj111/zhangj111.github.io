...
---
## 👋 Welcome
Dr. Jian Zhang is a Research Fellow at [Nanyang Technological University](https://www.ntu.edu.sg/), working with [Prof. Yang Liu](https://personal.ntu.edu.sg/yangliu/). His research focuses on advancing Software Engineering by integrating AI techniques into source code analysis to support maintenance tasks such as bug detection, vulnerability analysis, and program repair.
He received his Ph.D. in Computer Science from [Beihang University](https://www.buaa.edu.cn/), where he was supervised by  [Prof. Xudong Liu](https://scse.buaa.edu.cn/info/1078/2646.htm). He also holds a B.S. degree from the same institution.
